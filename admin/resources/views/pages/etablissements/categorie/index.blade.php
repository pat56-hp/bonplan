                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                @foreach($categories as $categorie)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('etablissements.categorie', $categorie->id) }}"><i class="fas fa-map-marked"></i> Divertissement</a>
                                                    <a class="dropdown-item" data-toggle="modal" data-target="#modalEdit-{{$categorie->id}}" href="#"><i class="fas fa-edit"></i> Modifier</a>
                                                    <a class="dropdown-item" href="{{ route('etablissements.categorie.delete', $categorie->id) }}" onclick="return confirm('Ête-vous sûre de vouloir supprimer cette categorie ?')"><i class="fas fa-trash"></i> Supprimer</a>
                                                    <a class="dropdown-item" href="{{ route('etablissements.categorie.status', $categorie->id) }}" onclick="return confirm('Ête-vous sûre de vouloir changer le statut de cette categorie ?')">
                                                        @if($categorie->status == 0)
                                        ...
                                        @include('pages.etablissements.categorie.edit')
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
