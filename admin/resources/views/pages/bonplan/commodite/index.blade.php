                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                @foreach($commodites as $commodite)
                                    <tr>
                                        ...
                                        <td>{{ $commodite->endroits->count() }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('bonplan.commodite.delete', $commodite->id) }}" onclick="return confirm('Ête-vous sûre de vouloir supprimer cette commodité ?')"><i class="fas fa-trash"></i> Supprimer</a>
                                                    <a class="dropdown-item" href="{{ route('bonplan.commodite.status', $commodite->id) }}" onclick="return confirm('Ête-vous sûre de vouloir changer le statut de cette commodité ?')">
                                                        @if($commodite->status == 0)
                                        ...
                                        @include('pages.bonplan.commodite.edit')
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
